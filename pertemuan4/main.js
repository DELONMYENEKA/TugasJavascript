...
const nama = "Delon M Yeneka";
let panggilan = "Delon";
const nim = 220117007;
let umur = "20 tahun";
const asal_kampus = "Universitas PGRI Sumatera Barat";
let kelas_yang_diikuti = "javascript";
...
console.log(nim);
console.log(umur);
console.log(asal_kampus);
console.log(kelas_yang_diikuti);
console.log(jenis_kelamin === P);